...
summary_renew_region_table <- data.frame(Region = c("North America", 
                                                      ...
                                                      "Oceania", 
                                                      "South America"), 
                                         Change_in_Annual_Investment_million_USD = c(region_model_summary$coefficients[2,"Estimate"], 
                                                                                         region_model_summary$coefficients[2,"Estimate"] + region_model_summary$coefficients[3,"Estimate"],
                                                                                         region_model_summary$coefficients[2,"Estimate"] + region_model_summary$coefficients[4,"Estimate"],
                                                                                         region_model_summary$coefficients[2,"Estimate"] + region_model_summary$coefficients[5,"Estimate"],
                                                                                         region_model_summary$coefficients[2,"Estimate"] + region_model_summary$coefficients[6,"Estimate"],
                                                                                         region_model_summary$coefficients[2,"Estimate"] + region_model_summary$coefficients[7,"Estimate"],
                                                                                         region_model_summary$coefficients[2,"Estimate"] + region_model_summary$coefficients[8,"Estimate"],
                                                                                         region_model_summary$coefficients[2,"Estimate"] + region_model_summary$coefficients[9,"Estimate"],
                                                                                         region_model_summary$coefficients[2,"Estimate"] + region_model_summary$coefficients[10,"Estimate"]),
                                         p_value = c(region_model_summary$coefficients[2,"Estimate"], 
                                                                                         region_model_summary$coefficients[2,"Pr(>|t|)"],
                                                                                         region_model_summary$coefficients[4,"Pr(>|t|)"],
                                                                                         region_model_summary$coefficients[5,"Pr(>|t|)"],
                                                                                         region_model_summary$coefficients[6,"Pr(>|t|)"],
                                                                                         region_model_summary$coefficients[7,"Pr(>|t|)"],
                                                                                         region_model_summary$coefficients[8,"Pr(>|t|)"],
                                                                                         region_model_summary$coefficients[9,"Pr(>|t|)"],
                                                                                         region_model_summary$coefficients[10,"Pr(>|t|)"])
)
```
